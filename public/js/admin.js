...
async function testAPIConnectivity() {
  ...
  try {
    ...
    const pingResponse = await fetch('https://hostel-grievance-portal.onrender.com/api/ping', {
      method: 'GET',
      headers: {
  ...
  if (!serverRunning) {
    try {
      ...
      const testResponse = await fetch('https://hostel-grievance-portal.onrender.com/api/test', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json'
        }
