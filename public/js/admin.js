...
async function testAPIConnectivity() {
  ...
  try {
    ...
    const pingResponse = await fetch('http://https://hostel-grievance-portal.onrender.com/api/ping', {
      method: 'GET',
      headers: {
  ...
  if (!serverRunning) {
    try {
      ...
      const testResponse = await fetch('http://https://hostel-grievance-portal.onrender.com/api/test', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json'
        }
  ...
  if (!serverRunning) {
    try {
      ...
      const healthResponse = await fetch('http://https://hostel-grievance-portal.onrender.com/api/health', {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json'
        }
  ...
  try {
    ...
    const response = await fetch('http://https://hostel-grievance-portal.onrender.com/api/health', {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json'
      }
